...
<div class="container">
     <h3>MANAGEMENT PROJECT</h3><hr>
          ...
          $sql = "SELECT PROJ_ID,
                        ...
                        STD_ID_3,
                        LEC_ID_1,
                        LEC_ID_2 FROM project WHERE LEC_ID_1  = '".$_SESSION['isid']."' OR LEC_ID_2 = '".$_SESSION['isid']."' ";
                  ...
                  if(mysqli_num_rows($res) == 0) {
                    ...
                    while($row = mysqli_fetch_assoc($res)) {
                      ...
                      if(mysqli_num_rows($res4) == 1){
                        ...
                        $lec_name = $r4['LEC_TITLE_NAME']." ".$r4['LEC_NAME']." ".$r4['LEC_SUR'];
                      }

                      if(mysqli_num_rows($res5) == 1){
                        $r5 = mysqli_fetch_assoc($res5);
                        $lec_name2 = $r5['LEC_TITLE_NAME']." ".$r5['LEC_NAME']." ".$r5['LEC_SUR'];
                      }
